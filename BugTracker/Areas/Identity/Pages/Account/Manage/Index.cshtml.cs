...
namespace BugTracker.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        // Constructor for IndexModel, accepting UserManager and SignInManager through dependency injection
        public IndexModel(
            ...
            SignInManager<BugTrackerUser> signInManager)
        {
            ...
            _signInManager = signInManager; // Assigning the injected SignInManager
        }
